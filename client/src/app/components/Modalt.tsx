  ...
  return (
    <Dialog open={open} onOpenChange={setOpen} >
            <DialogTrigger asChild>
              <Button variant="outline" className="rounded-full ml-4 text-xs">Profile</Button>
            </DialogTrigger>
    ...
    <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
        <img className="object-cover object-center h-32" src={member?.profilePicture ? member?.profilePicture : "https://cdn-icons-png.freepik.com/512/219/219986.png"} alt='Woman looking front'/>
    </div>
